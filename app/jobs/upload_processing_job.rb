...
class UploadProcessingJob < ApplicationJob
  ...
  def perform(upload_id)
    ...
    begin
      ...
      # Step 3: Search metadata sources for enrichment
  ...
  def find_or_create_book_with_metadata(metadata:, extracted:, parsed:)
  ...
  def trigger_library_scan(book)
    library_id = SettingsService.get(:audiobookshelf_audiobook_library_id)
