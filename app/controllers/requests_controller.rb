...
class RequestsController < ApplicationController
  ...
  def create
    ...
    warning = duplicate_check.message if duplicate_check.warn?
  ...
  def path_within_allowed_directories?(path)
    ...
    return false if audiobook_path.blank?

    # Check if path is within audiobook directory
    expanded_allowed = File.expand_path(audiobook_path)
  ...
  def find_or_create_book_for_source(work_id)
